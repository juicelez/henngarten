			...
			<div className="row gap-5">
				<div className="col-auto col-lg d-flex flex-column justify-content-center dark">
					...
					<p className="text-secondary">
						Gartenbau ist die Kunst und das Handwerk der Gestaltung,
						Pflege und Verschönerung von Gärten und Grünflächen. Als
						Garten- und Landschaftsbauer bringen wir Fachkenntnisse
						und Kreativität in Ihren Garten und bringen Ihre
						Vorstellungen in die Gestaltung mit ein.
					</p>
				</div>
