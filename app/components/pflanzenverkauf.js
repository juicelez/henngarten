			...
			<div className="row gap-5">
				<div className="col-auto col-lg d-flex flex-column justify-content-center dark">
					...
					<p className="text-secondary">
						Entdecken Sie unsere breite Auswahl an selbst
						gezüchteten und aufgezogenen Pflanzen. Wir legen großen
						Wert auf Qualität und bieten Ihnen gesunde Pflanzen für
						Ihren Garten oder Innenbereich. Alles regional im
						Enzkreis erzeugt und großgezogen. Qualität die sich
